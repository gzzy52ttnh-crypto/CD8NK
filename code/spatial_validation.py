...
if len(intra_df) >= 3:
    ...
    wc_stem = type('obj',(object,),{'pvalue':1.0})()
    wc_nk = type('obj',(object,),{'pvalue':1.0})()
...
if len(group_data[0]) >= 2 and len(group_data[3]) >= 2:
    ...
    mw_4g = type('obj',(object,),{'pvalue':1.0})()
...
if len(intra_df) >= 1:
    intra_df.to_csv(os.path.join(RESULT, 'spatial_intrapatient_pairs.csv'), index=False)
